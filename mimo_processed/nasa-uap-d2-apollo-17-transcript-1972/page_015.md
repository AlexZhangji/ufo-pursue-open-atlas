...
| | LMP | For our interp - If we can extrapolate from the samples returned by other missions. |
...
| | CC | Okeydoke. |
| 03 15 35 50 | CDR | Say, Gordo, something I just noticed here in working with the GDC what-have-you. I - looked at the Pc gage, and in the Pz - Pc position, there is a continuous bias on it now of about, oh, 7 percent, and if I switch to ALPHA, it goes to zero. We never saw that bias before this last burn. |
| | CC | Roger, Gene. |
| 03 15 36 35 | LMP | Hey, Gordy, I'm looking right up the western edge of the Procellarum mare where it contacts the - the - the high - western highlands of the Moon, and we're just about to fly a little bit south of Grimaldi. That edge is very irregular. There is no obvious indications that it - there are large basins that have been flooded by mare that have formed that edge, but, again, the topographic distinction's possible in this lighter small. Now I'm starting to see that there are shadows in the craters. |