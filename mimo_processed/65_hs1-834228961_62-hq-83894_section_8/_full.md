...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive (cleanup pass for rejected pages). Source PDF: 65_hs1-834228961_62-hq-83894_section_8.pdf.
...
*Image: A faded, off-white document page, appearing to be the reverse side of a form or a cover sheet. The paper shows signs of aging, with two punched holes at the top and torn edges on the left. At the top, faint watermark text reads "EAGLE-A TROJAN BOND" and "100% COTTON CONTENT U.S.A."*
...
*Image: A vertical, standard manila file folder or envelope, yellowish-tan in color. It has a single hole punched at the top center and two holes punched at the bottom. A horizontal crease runs across the top third, indicating a fold. There are no other printed forms, text, or markings on the main body of the folder.*
...
*Image: line drawing sketch of a disc-shaped object with a dome, trailing motion lines, positioned to the right of the main text.*
...
*Image: A yellow manila document envelope or folder flap, oriented vertically. Two punched holes are visible at the top edge. A clear plastic fastener or label holder is affixed near the bottom center.*
...
*Image: A series of five hand-drawn sketches labeled 1 through 5, showing a crescent moon and a small black dot (the object). The moon's orientation is marked with S (South) at the top and N (North) at the bottom. The object's position relative to the moon changes in each sketch. In sketch 3, a horizontal line is drawn across the moon's width with the text "1081 MILES". The sketches are arranged horizontally across the page.*
...
*Image: A single page containing a mounted newspaper clipping. The page itself is a light-colored paper with two binder holes at the top. At the bottom, a typed label provides metadata for the clipping.*
...
*Image: Handwritten note in blue ink in the upper right quadrant reads "O Flying Saucers".*
*Image: Handwritten note in blue ink in the left margin reads "file" with two vertical strokes beneath it.*
*Image: Handwritten note in blue ink in the lower left quadrant reads "6 28" over a red circle.*
*Image: Handwritten note in red ink in the lower right quadrant is a large looped symbol, possibly a "B" or "8".*
...
*Image: Faint blue pencil markings in the center of the page, possibly "nr: 986... 102... ICE... CT" and other illegible characters.*

*Image: Purple date stamp in lower right quadrant: "NOV 24 1954"*

*Image: Handwritten signature in black ink over the date stamp: "Edw Mossburg"*
*Image: Below signature, handwritten in blue ink: "DIV page 2" and stamped in blue ink "INVESTIGATIVE"*

*Image: Handwritten note in black ink in lower left: "27292"*
*Image: Handwritten note in black ink in lower left margin: "58 DEC 7 - 1954"*

*Image: Black ink stamp in lower right margin, partially illegible, contains "EC" and "File 8-11"*
...
*Image: A typewritten document on aged paper. A faint blue handwritten number "54" and "20" are visible in the left margin. A blue pen mark crosses out the "S" in "STRINGFIELD" in the first paragraph. A small red handwritten note, possibly "Ok. J.D.", is in the right margin next to the second paragraph.*
...
*Image: A newspaper clipping from the "Rome Daily American" dated Tuesday, September 28, 1954, is pasted onto a blank page. The headline reads "Windshield 'Cancer' Epidemic Moving To Northern Italy". The article text describes mysterious windshield explosions. At the bottom of the page, a handwritten notation reads "62. 83894 - 351" next to a faint, typed "ENCLOSURE".*
...
*Image: A handwritten letter on off-white paper, slightly torn at the top left corner. The letter is written in blue ink with some additions in red ink and pencil. A black circular ink blot covers part of the return address at the top.*
...
*Image: A faded, yellowed, single-page document, appearing to be the reverse side or a heavily bled-through copy of an Office Memorandum. The text is largely illegible due to bleed-through from the other side, with only the top letterhead, some handwritten annotations, and a stamp being clearly visible.*

---

### RECEIVED

*Image: A blue ink stamp in the lower left quadrant of the page, oriented upside-down relative to the main text.*
...
*Image: Two punch holes at the top edge of the document. There is a brown stain or smudge near the right punch hole.*
...
*Image: A scanned image of the front of a used, brownish paper envelope. It features a handwritten return address and addressee, a circular postmark, and a partial slogan cancellation stamp.*
...
*Image: A single, yellowed, aged page with a torn top edge and several punch holes. The text on the page is printed or typed upside-down relative to the standard orientation. The page contains a typed paragraph and a stamped notation block.*
...
*Image: Scanned document page, rotated 90 degrees clockwise. The page appears to be the back of a form or routing sheet, showing faint "bleed-through" text from the other side. The page is covered with numerous date/time stamps in blue and purple ink, indicating various receipt and routing dates in April and March of 1956. Handwritten text is visible in the bottom right corner.*
...
*Image: Document header "STANDARD FORM NO. 64" with punch holes and black ink blots obscuring parts of the title.*

### Stamps and Annotations
- **RECORDED-37**
- **EX-177**
- *[handwritten signature]:* J. Edgar Hoover *[handwritten note]:* PERS. FILES
- *Image: Red "RECORDED-37" and "EX-177" stamps at bottom. Handwritten signature "J. Edgar Hoover" with "PERS. FILES" annotation in red ink.*
...
*Image: A handwritten note in the top right corner reads "PERS FILES" with a red line drawn through it.*
...
*Image: A red stamped date at the bottom reads "58 APR 26 1956".*
...
*Image: Document shows signs of aging, with punch holes at the top and minor staining. The main text appears to be a mirrored impression from the reverse side of the page, making it largely illegible. The bottom section contains clear, legible stamps and handwritten notations.*
...
*Image: A handwritten signature "Jim [illegible]" is written over the "FROM" line.*
...
*Image: A scan of a white document page, appearing mostly blank. Two hole-punch marks are visible at the top. A faint, illegible, and reversed blue stamp or text is visible near the top center. At the bottom center, a clear, blue ink stamp is printed upside down. The stamp text is transcribed above. There are some brown stains in the bottom right corner.*
...
*Image: A tan manila paper envelope or folder. It has two punched holes at the top for binder insertion. A rectangular outline suggests a sealed inner pocket or window. The paper shows age-related toning and a central vertical crease.*
...
*Image: A manila-colored document envelope or folder. At the top left, the word "ENCLOSURE" is stamped in red. At the top right, the reference number "62-83894-373" is handwritten in red ink. A small piece of brown adhesive tape is stuck at the very top center, near the curved edge. In the center of the envelope face, two larger strips of brown adhesive tape are crossed in an "X" shape, with a small staple or pin visible at the intersection. A vertical strip of brown tape is affixed along the bottom left edge. Two hole-punch circles are visible near the bottom edge. The envelope is otherwise blank. The paper is aged and yellowed. The background is solid black, indicating it was scanned or photographed against a dark backdrop.*
...
*Image: A yellowed, rectangular newspaper clipping typed on a Washington City News Service teletype form, adhered to the page with translucent tape. The text is in all-caps monospaced type. The paper shows age-related discoloration.*
...
*Image: The document is a standard form memo, "Office Memorandum - UNITED STATES GOVERNMENT". The paper is aged and discolored. It has two punch holes at the top. There are multiple overlapping stamps in blue, purple, and red ink across the bottom half. A handwritten number "324" in red ink is visible in the left margin.*
...
*Image: A standard tan/brown manila folder, appearing aged, with two hole-punches at the top edge. The folder is mostly blank, showing vertical crease lines. A metal fastener is visible at the bottom center. A strip of adhesive tape is affixed horizontally across the bottom, over which the following markings are present.*
...
*Image: Two dark, circular US postage stamps affixed to the upper right corner. The left stamp is fully visible; the right stamp is partially obscured by the postmark and torn edge.*
...
*Image: This document appears to be a single page of aged, off-white paper with visible creases and two punch holes at the top. The text is largely illegible, faded, and reversed (mirrored), indicating it may be a carbon copy or seen through from the other side. A prominent blue ink stamp is visible in the lower-left quadrant. Handwritten notations are present in red ink at the bottom right.*
...
*Image: A pink paper routing slip with numerous stamped dates and department names in black ink, oriented vertically and diagonally. The text is faint and appears to be the reverse of a document. Handwritten notation "Cl-11-18" is in the bottom left corner. Two hole-punch marks are at the top.*
