...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: dow-uap-d74-mission-report-syria-november-2023.pdf.
...
*[Large redaction block covering most of the page]*
...
*   **Primary Sensor:** FMV
*   **Sensors Available:** *[REDACTED — 1.4(g)]*
*   **Tasking Type:** Dynamic
*   **Tasking or Request Number (JTAR#, AEM#, PRI#, or TIC#):** DATA MASKED
*   **BE Number (if NTISR):** -
*   **Tasked Start Point:** 37S FU 81 *[REDACTED — 1.4(a)]* 06 *[REDACTED — 1.4(a)]*
...
UPON ARRIVAL TO THE SP AT 0431Z, *[REDACTED — 1.4(a)]* OBSERVED NO EEI RELATED ACTIVITY. AT 0528Z, IT WAS 1X VEHICLE PARKED E OF COI WAS ASSESSED AS A PROB IMINT MATCH TO VOI. AT 0539Z, *[REDACTED — 1.4(a)]* RECEIVED A NEW TASKING. *[REDACTED — 1.4(a)]* REMAINED ONTGT UNTIL PUSHING TO NEW COORDS AT 0554Z.
~~(SECRET/REL TO USA, FVEY)~~

### *ISR ASSET UTILIZATION*
*   **Supported Unit:** *[REDACTED — 1.4(g)]*
...
~~SECRET//NOFORN~~
06/02/2025 000006
Approved for Release to AARO *[REDACTED — 1.4(a)]*
...
*   **UAP Description (e.g., size, shape, color, markings, recognizable features):** SHOWED AS *[REDACTED — 1.4(g)]*
*[REDACTED — 1.4(g)]*
*   **Gentext (UAP Event Description):** ~~(SECRET//NOFORN)~~
WHILE RTB AT 2153Z, *[REDACTED — 1.4(a)]* OBSERVED 1X PROB HC UAP SHAPED AS A BOUNCY BALL
COME FROM THE SOUTH AT NEAR CO-ALT. *[REDACTED — 1.4(a)]* OBSERVED THE PROB UAP DROP
ALTITUDE AND SAFELY PASS THEIR AIRCRAFT WHILE CONSISTANTLY MAINTAINING
~424KN. AFTER 7MIN OF WATCHING, THE PROB UAP BECAME OUT OF RANGE AND *[REDACTED — 1.4(a)]*
CARRIED ON THEIR RTB. NO EMISSIONS CAME FROM THE PROB UAP, UAP WAS NOT
