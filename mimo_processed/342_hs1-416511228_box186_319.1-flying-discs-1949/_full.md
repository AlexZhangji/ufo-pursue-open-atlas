...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: 342_hs1-416511228_box186_319.1-flying-discs-1949.pdf.
...
*Image: The document is the reverse side of a typewritten page. The text from the front side is faintly visible in reverse through the thin paper. A large, irregular black shape obscures the bottom left corner. A small, black, circular punch hole or mark is visible near the bottom right.*
...
*Image: Scanned back or cover sheet of a vintage document. The page is mostly blank with visible bleed-through text from the reverse side. At the bottom left is a circular time-punch clock stamp with a 12-hour dial and the date "SEP 2 7 1949". To the right of this is faint, illegible handwriting and a faded blue ink date stamp reading "SEP 23 - 2 31 PM '46". There are three dark circular holes punched along the top edge of the paper.*

## Document Marks

**Bottom Left:**
*   **Date Stamp:** SEP 2 7 1949
*   *Image: A circular mechanical time clock stamp. The outer ring is marked with numbers 1 through 12. An inner triangle contains a smaller arrow pointer. The date "SEP 2 7 1949" is printed in a straight line beneath the circle.*
...
*Image: Faint pencil handwriting in the center of the page appears to read "May 8" or "Nay 8", followed by a horizontal line and a vertical tick mark.*
...
*Image: In the upper right corner of the document, there are large, handwritten initials in black ink, appearing to be "L.B.F."*
...
*Image: Faint circular stamp in lower right corner, partially illegible, appears to be a received or filed stamp.*
...
*Image: Hand-drawn diagram representing a circular radar scope display. A large circle dominates the page. A vertical line extends from the top center of the circle down to the center point, labeled "LUBBER LINE". Inside the circle, to the left of center, is an irregular black blob labeled "ROTA ISLAND". To the right of the center point is another irregular black blob labeled "GUAM". Emanating from the "GUAM" blob towards the right are four concentric arc lines, increasing in radius. A label below these arcs reads "INTERFERENCE AS IT APPEARED ON THE SCOPE". The scope's center point is a small black circle.*
...
*Image: Hand-drawn map and trajectory diagram on aged paper. The map depicts a coastal area, likely in New England, showing islands labeled "Puffin I.", "Bear I.", "Egg Rock", "Duck I.", "Little Duck I.", "Englishman Bay", and "Bass Harbor Head Light". A trajectory line with arrows indicates an object's path from right to left (East to West). A circle is drawn around "St. Paul Light". A smaller diagram in the lower left shows altitude vs. distance. A compass rose points North to the right. A point is marked "Gerhune residence - Keduck".*
...
*Image: Hand-drawn sketch map and profile diagram showing an "atmospheric disturbance" flight path over a coastal area in Alaska.*

### Main Map: Flight Path
*Image: A hand-drawn map of a coastal region showing islands, bays, and an airport. A thick black line with arrows indicates a flight path moving from right to left (east to west). Key locations are labeled, and a table of data is included on the left side.*
...
*Image: A hand-drawn side-view diagram showing altitude and trajectory. The horizontal axis is not labeled. The vertical axis shows altitude in feet.*
...
*Image: A stamped "RESTRICTED" classification label appears at the top center of the document. A small black hole-punch artifact is visible to the left of the stamp.*

*Image: A black circular stamp is located to the right of the "RESTRICTED" label, partially obscured by a handwritten annotation.*

*Image: A handwritten annotation in cursive ink in the upper right corner reads "Capt Hathway File".*

*Image: In the upper left corner, "CM 175" is handwritten in blue pencil.*
...
*Image: A handwritten signature is present in the signature block, appearing to read "M. D. GENTRY".*
...
*Image: A red "RESTRICTED" stamp appears in the bottom right corner of the page.*
...
*Image: A pink-colored form with pre-printed headers and typed content. There are two large black holes at the top, likely from a binder or punch. The word "SECRET" is crossed out with a single line. A large stamp reads "ACTION COPY" with "MATS" above it. A handwritten note "23 Feb MATS" appears in the top right corner.*
...
*Image: A hand-drawn sketch on aged, off-white paper with a faint horizontal fold line. The sketch depicts a disc-shaped or oval aircraft viewed from a low front angle. The aircraft has a rounded body, a cockpit canopy on top, two engine nacelles with propellers mounted on short pylons near the rear of the body, and two thin, pointed tail structures extending downwards. Two U.S. military star-and-bar roundels are visible on the sides of the fuselage. Faint pencil lines extend from the bottom of the sketch, possibly indicating motion or exhaust. The paper shows minor imperfections and three punch holes at the top edge.*
...
*Image: A red stamp "ACTION COPY" with a smaller "PRIORITY" stamp overlapping the top right corner. Handwritten annotation in red ink above reads "13 Feb." with initials "S.H" below.*
...
*Image: Handwritten numbers "655" appear above the text line "TIME ONE ONE FEBRUARY FOUR NINE".*
...
*Image: Scan of a faded, pinkish-tan document back or routing slip. The paper has two punched holes at the top with some tearing. At the top left is a reversed (mirror-image) ink stamp, likely from the front side of the document. At the bottom is a block of reversed (mirror-image) routing stamps and notations. A small black horizontal line is visible near the center.*

*Image: * At the top left, a reversed ink stamp reads:**
`P1/3542L`

*Image: * Near the top center, a reversed handwritten annotation in pencil or light ink reads:**
`*F.B.I.*`
...
*Image: A pinkish paper form titled "DEPARTMENT OF THE ARMY STAFF MESSAGE CENTER INCOMING CLASSIFIED MESSAGE". The form contains typed text detailing an unidentified flying object report. There are several large, black, sans-serif stamps overlaid on the text, including "MATS", "PRIORITY", "USAF DIST ACTION", "INFO", "OIN", "CSL", "CFO", "COM", and "ACTION COPY". Handwritten annotations include a large "MATS" in the top right and "PL/INT" and "ES" in the bottom right corner. The document has a red "ACTION COPY" stamp in the bottom right. The bottom margin contains GPO printing information and a warning against exact copying.*
...
*Image: A large, black, sans-serif stamp in the bottom right corner reads "ACTION COPY". Above it, a smaller stamp reads "MATS". Within a box, there are fields:*
...
*Image: A hand-drawn map of Japan showing several locations marked as observing stations (●). A line (—) labeled "PROBABLE PATH OF PHENOMENON" connects several of these stations. A red cross (✕) labeled "PROBABLE AREA OF EXPLOSION OR DISAPPEARANCE" is marked near one station. The observing stations are labeled: FUKUSHIMA, NAGANO, TAKAYAMA, SUWA, IIDA, and GIFU. The map includes a grid overlay. In the bottom left corner, there is a handwritten annotation: "Incl 4³".*
...
*Image: Hand-drawn weather or plotting map on white graph paper, showing the outlines of Japan and surrounding regions. The map is heavily annotated with handwritten numerical data, meteorological station plots, and hand-drawn isobars (dark curved lines). Several areas are shaded in green, yellow, and blue. Dark circular punch-holes are visible near the top margin. Numbers are written in black ink. Grid lines (brown/red) and coastline outlines are visible.*
...
*   *Image: Large blue hand-drawn lines (likely isobars or flight paths) traverse the map from left to right.*
*   *Image: Areas of green shading are visible near the center and top right.*
*   *Image: Areas of yellow shading are visible near the bottom left.*
*   *Image: Reddish-brown coastline outlines depict the Japanese archipelago.*
*   *Image: Grid lines divide the map.*
...
*Image: A rubber stamp mark with the word "SECRET" crossed out by a single line.*
...
*Image: A detailed, hand-drawn map on beige paper depicting the Fairfield-Suisun Air Force Base layout. A bold red line with cross markers traces a flight path from the upper right, down over the base, and off the bottom edge. Handwritten annotations in blue ink describe the object's movements. A red signature is visible at the bottom.*
...
*Image: Hand-drawn sketch of a circle with short lines radiating outward from its perimeter, resembling a sun. A horizontal line is drawn across the center of the circle. Inside the circle, above the line, is handwritten text "30\"".*
...
*Image: Hand-drawn sketch of an elongated, cylindrical or cigar-shaped object. The object tapers slightly from a wider front to a narrower rear.*
...
*Image: Large faded stamp in upper left corner reading "COPY".*
...
*Image: Handwritten signature reading "Rush L. Kelley"*
