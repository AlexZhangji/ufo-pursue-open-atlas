...
*Image: hand-drawn sketch of the observed object from two viewpoints.*
*   **Top View:** A roughly circular/oval shape labeled "Top". An arrow above points to the right with handwritten note "*traveling this way*". An arrow from the right points to the shape.
*   **Side View:** A long, thin, crescent or saucer-like profile labeled "side view". An arrow above points to the right with handwritten note "*traveling This way*".
*   Next to the drawings is the typed note: "They seemed longer than wide, their thickness was about 1/20th of their width"
*   Below the side view drawing is the typed note: "Mirror Bright"
*   Final typed note: "They did not appear to me to whirl or spin but seemed in fixed position, traveling as I have made drawing."

### /s/ Kenneth Arnold

*[handwritten annotation, bottom right]:* 7/16/46

*[handwritten annotation, bottom right corner]:* 90
