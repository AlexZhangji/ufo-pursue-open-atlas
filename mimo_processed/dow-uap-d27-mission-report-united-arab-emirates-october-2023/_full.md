...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: dow-uap-d27-mission-report-united-arab-emirates-october-2023.pdf.
...
AT 2100Z, *[REDACTED — 1.4(a)]* TOOK OFF FROM OMAM VIA SLR. *[REDACTED — 1.4(a)]* PROCEEDED TO FRAGGED TASKING.

AT 1822Z, *[REDACTED — 1.4(a)]* WAS 7-LINED. *[REDACTED — 1.4(a)]* DID NOT ARRIVE ON-STATION DUE TO WX RTB (SEE ON/OFF STATION 1).

AT 2256Z, *[REDACTED — 1.4(a)]* CONDUCTED A NON-INTERFERENCE BASIS TASKING (SEE NIB 1).

AT 0444Z, *[REDACTED — 1.4(a)]* CONDUCTED A NON-INTERFERENCE BASIS TASKING (SEE NIB 2).

AT 0457Z, DURING RTB *[REDACTED — 1.4(a)]* DETECTED 1X UAP (SEE UAP 1).

AT 0405Z, *[REDACTED — 1.4(a)]* RETURNED TO BASE. AT 0713Z, *[REDACTED — 1.4(a)]* CONDUCTED SLR AND LANDED AT OMAM. 10:13 MISSION HOURS.
*(SECRET//NOFORN)*

## *(S//REL UFG)* Mission Narrative
...
*   **Combatant Command (COCOM):** USCNTCOM
...
*   **Rank:** SrA
*   **Full Name:** *[REDACTED — 1.4(a) Exemptions (b)(3), 1.30b, (b)(6)]*
*   **Unit:** Unavailable
*   **Wing:** 27 SOW
...
24 October 2025
By MG Richard A. Harrison
USCENTCOM Chief of Staff

* [CLASSIFICATION STAMP REDACTED] *
...
*   Asset Type (Aircraft Type): *[REDACTED — 1.4(a), (b)(1)1.4g]*
...
*   **Gentext/Additional Details:** *(SECRET//REL TO USA, FVEY)*
    AT 1822Z, *[REDACTED — 1.4(a)]* WAS 7-LINED. DID NOT ARRIVE ON-STATION DUE TO WX RTB AT 0405Z.
    *(SECRET//REL TO USA, FVEY)*
...
*   **Target Name:** *[REDACTED — 1.4(a)]*
*   **Location of Interest (LOI):** -
*   **Location (MGRS):** 40RGM *[REDACTED — 1.4(a)]* *[REDACTED — 1.4(a)]*
*   **Requested Classification of Reports:** *(SECRET//REL TO USA, FVEY)*
*   **Dissemination POCs or Common File:** -
*   **EEIs:** *(SECRET//REL TO USA, FVEY)*
    A. BEGIN SCANS AT 75NM WEST, NORTH, AND EAST OF SP FOR DHOWS TRANSITING IN THE DIRECTION OF SP
    B. PROVIDE SITREP WITH FLAG STATUS, FLAG, OR NO FLAG VISIBLE AND COUNTRY OF FLAG (IF POSSIBLE), COORDINATES AND OBSERVED ACTIVITY.
    C. CALL OUT ANY IDENTIFIABLE EQUIPMENT, COMMS EQUIPMENT, PERSONS WEAPONS, CARGO ON BOARD TO INCLUDE CANCAS COVERED ITEMS
    *(SECRET//REL TO USA, FVEY)*

*GENTEXT/NIB*

*   **Gentext:** *(SECRET//REL TO USA, FVEY)*
    UPON ARRIVAL TO SP AT 2256Z, *[REDACTED — 1.4(a)]* OBSERVED NO PERSONNEL OR VEHICLE ACTIVITY.
    BETWEEN 2257Z-2330Z, *[REDACTED — 1.4(a)]* CONDUCTED SCANS IVO THE SP AND PROVIDED CALLS ON ANY DHOW ACTIVITY. ITC INTENT MET.
    *(SECRET//REL TO USA, FVEY)*
...
## [DECLASSIFIED — 24 October 2025]

*[Top-right red text:]* Declassified by MG Richard A. Harrison
USCENTCOM Chief of Staff
Declassified on: 24 October 2025

*[Top-center redacted box:]* *[REDACTED — 1.4(a)]*
...
*   **UAP Description (e.g., size, shape, color, markings, recognizable features):** (SECRET//NOFORN) *[REDACTED — 1.4(a)]*
    ...
    (SECRET//NOFORN) *[REDACTED — 1.4(a)]*
*   **Gentext (UAP Event Description):** (SECRET//NOFORN) *[REDACTED — 1.4(a)]*
    DURING RTB AT 0457Z, *(b)(1)1.4a* OBSERVED 1X UAP WHILE TRANSITING OVER 40RFM69*(b)(1)1.4a* FLYING AT AN ALTITUDE OF 23,999FT MSL AND SPEED OF 163KTS.
    (SECRET//NOFORN) *[REDACTED — 1.4(a)]*
...
*   **Location of Interest (LOI):** -
*   **Location (MGRS):** 40RFM69*(b)(1)1.4a* *(b)(1)1.4a*
*   **Requested Classification of Reports:** *(SECRET//REL TO USA, FVEY)* *[REDACTED — 1.4(a)]*
*   **Dissemination POCs or Common File:** -
*   **EEIs:** (SECRET//REL TO USA, FVEY) *[REDACTED — 1.4(a)]*
A. BEGIN SCANS AT 75NM WEST, NORTH, AND EAST OF SP FOR DHOWS TRANSITING IN THE DIRECTION OF SP
B. PROVIDE SITREP WITH FLAG STATUS, FLAG, OR NO FLAG VISIBLE AND COUNTRY OF FLAG (IF POSSIBLE), COORDINATES AND OBSERVED ACTIVITY.
C. CALL OUT ANY IDENTIFIABLE EQUIPMENT, COMMS EQUIPMENT, PERSONS WEAPONS, CARGO ON BOARD TO INCLUDE CANCAS COVERED ITEMS

*[Bottom center box:]* 3.5c, FOIA Exemption (b)(6)

*[Bottom center redacted box:]* *[REDACTED — 1.4(a)]*
