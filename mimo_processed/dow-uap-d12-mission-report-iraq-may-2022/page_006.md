...
*   **UAP Description (e.g., size, shape, color, markings, recognizable features):** (S//REL) *[REDACTED — 1.4(a)]* OBSERVED A UAP AT 2043Z FLY NORTH TO NORTH EAST AND FOLLOWED AS LONG AS POSSIBLE. *[REDACTED — 1.4(a)]* SCREENER COULD NOT GET A POSITIVE ID ON THE UAP.
