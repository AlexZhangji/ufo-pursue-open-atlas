...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: dow-uap-d12-mission-report-iraq-may-2022.pdf.
...
~~(S//REL)~~ AT 0542Z, *[REDACTED — 1.4(a)]* TOOK OFF LATE FROM OKAS. AT 0551Z, *[REDACTED — 1.4(a)]* HANDED OVER FROM THE LRE. FROM 0614Z TO 2346Z, *[REDACTED — 1.4(a)]* COLLECTED SIGINT VIA AIRHANDLER VERSION 2. FROM 0927Z TO 2121Z, *[REDACTED — 1.4(a)]* SUPPORTED OP PHANTOM FLEX IVO 38SMC*[REDACTED — 1.4(a)]*20*[REDACTED — 1.4(a)]* ISO MAG (SEE ISR 1). AT 2121Z, *[REDACTED — 1.4(a)]* WAS CLEARED TO RTB. AT 0005Z, *[REDACTED — 1.4(a)]* HANDED BACK TO THE LRE. AT 0036Z, *[REDACTED — 1.4(a)]* LANDED AT OKAS. FMV WAS EXPLOITED BY DGS 1.
...
* **Unit:** 609 AOC
* **Wing:** Other
* **Phone Numbers:** *[REDACTED — 3.5c, FOIA Exemption (b)(6)]*
* **Email:** *[REDACTED — 3.5c, FOIA Exemption (b)(6)]*
* **Service:** Air Force
* **Operations Center:** 609 CAOC
...
• **Gentext/Additional Details:** ~~(S//REL)~~ *[REDACTED — 1.4a]* AT 0542Z, TOOK OFF LATE FROM OKAS DUE TO COMM ISSUES.
• **Mission Canceled:**
...
*   **Aircraft Callsign:** *[REDACTED — 1.4c]*
*   **Msn Type:** RECON

*[1.4c]*

*   **Tasking Type:** Planned
*   **Tasking or Request Number (JTAR#, AEM#, PRI#, or TIC#):** *[REDACTED — 1.4a]*
*   **BE Number (if NTISR):**
*   **Tasked Start Point:** 38S MC 36*[REDACTED — 1.4a]* 20*[REDACTED — 1.4a]*
...
*   **Gentext:** *(S/REL)* *[REDACTED — 1.4a]* COORDINATED WITH MAG 136 MINUTES PRIOR TO TAKE OFF. PRE-COORDINATION WAS SATISFACTORY DUE TO THE SUPPORTED UNIT PROVIDING ADEQUATE MISSION INFORMATION. AT 0927Z, *[REDACTED — 1.4a]* ARRIVED ON OP *[REDACTED — 1.4a]* ISO MAG AND CONDUCTED FMV AND SI. AT 2121Z, *[REDACTED — 1.4a]* WAS CLEARED OFF STATION AND RETURNED TO BASE.

*ISR ASSET UTILIZATION*

*   **Supported Unit:** MAG
*   **Supported Operation:** OP*[REDACTED — 1.4a]*
...
*   **Gentext:** *(S/REL)* *[REDACTED — 1.4a]* WAS EFFECTIVE.
