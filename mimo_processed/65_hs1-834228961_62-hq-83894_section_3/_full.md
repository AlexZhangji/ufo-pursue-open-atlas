...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: 65_hs1-834228961_62-hq-83894_section_3.pdf.
...
*Image: Black-and-white photograph of two dark, rocky or metallic fragments placed on a light-colored surface. The upper fragment is elongated and irregular with a porous, textured surface. The lower fragment is more blocky and angular, with a fractured or chipped face showing a slightly glossy interior. A small, dark, circular object is visible to the left between the two fragments. The photograph appears to be an archival evidence shot.*
...
*Image: black-and-white photograph of a heavily corroded, irregularly shaped metallic fragment or artifact. The object is dark, textured with corrosion or encrustation, and features multiple protrusions, twisted forms, and what appears to be a segment of a mesh or woven material protruding from the top. The background is a plain, light-colored surface. The photograph itself is mounted or printed on a card.*
...
*Image: Black-and-white photograph of two dark, irregularly shaped fragments or shards. The upper fragment is larger with a rough, striated texture resembling wood grain or fibrous material. The lower fragment is flatter and smoother with visible scratch marks. A small, dark, oval-shaped object is positioned to the left of the lower fragment. Both fragments are set against a light, plain background.*

### CONFIDENTIAL

*(Stamped at top center with punch holes on either side)*

*Image: Two fragments, upper fragment approximately triangular with vertical striations, lower fragment rectangular with smooth surface. Small oval object to the left.*
...
*Image: Black-and-white photograph of a dark, heavily textured, and irregularly shaped object, possibly slag, residue, or a fragment of material. It has a rough, pitted surface with some smoother, possibly melted or fused areas. The object appears to have a hole or depression near the center-left. Attached to the top of the main mass is a smaller, distinct piece that looks like a woven or mesh-like fabric, possibly a strap or filter material. The object is photographed against a plain, light-colored background, likely paper or a lab surface. A faint shadow is cast to the left and slightly below the object.*
...
*Image: A vertical black-and-white photograph showing two dark, irregular, slag-like fragments. The top fragment is roughly square with a highly textured, porous surface. The bottom fragment is elongated and rectangular, also appearing charred or metallic. A small, dark, oval-shaped object, resembling a seed or a small metal slug, is positioned to the left of the fragments, likely for scale. The background is a plain, light-colored surface.*
...
*Image: A single, aged, cream-colored sheet of paper, likely a carbon copy or the back of a typewritten document. The paper shows significant aging, with some discoloration and minor staining. At the top, two dark holes are visible, suggesting it was once fastened in a binder or file. The page is dominated by faint, reverse-ink text, indicating it is the verso side of a typewritten memo. Several blue ink stamps and handwritten annotations are present, primarily in the lower half. The right edge of the paper is irregular and torn.*
...
*Image: A scan of a worn, tan manila envelope or folder. The top edge is rounded. A black circular hole punch is visible near the top center. Two similar hole punches are visible near the bottom edge. The right edge is tattered and shows staple marks.*
...
*Image: A standard US Government Office Memorandum form. Handwritten annotations include a circled "RD" near the top right, a large handwritten signature that appears to read "Fletcher" on the right side, and various file numbers and dates stamped or written at the bottom.*
...
*Image: A rectangular, black ink stamp is in the lower right corner. The stamp reads: "FEDERAL BUREAU OF INVESTIGATION / U.S. DEPARTMENT OF JUSTICE / SEP 12 1947". Below the date, the fields "SAN FRANCISCO" (likely) and "FILE" are visible.*
...
*Image: The page is a pink teletype slip with various stamps, typed text, and handwritten annotations.*
...
*Image: A scanned image of the front of a white, rectangular, vintage envelope. The paper shows age with slight yellowing and faint brown staining in the lower-left quadrant. The top-left corner is torn and missing. The envelope is addressed via typewriter. In the upper-right corner are two identical purple United States postage stamps, each 3 cents, depicting the Statue of Liberty. They are cancelled by a circular postmark. Handwritten annotations in blue ink and pencil are visible.*
...
*Image: Hand-drawn sketch in blue ink on the lower half of the typed page. On the left, a rough circle labeled "Top / Very Bright / like Silver or / mirror." In the center, the text "Direction of travel: -> -> ->" with arrows pointing right. Below this, a handwritten note reads "appeared Black / outline as above / against snow of / Mt. Rainier." On the right, a long, thin, elliptical shape is labeled "Side View (Black) / Color." Above this, text reads "(no smoke trails / or vapor trails) / one looked / like this the / second from last / of the formation / Seemed a little smaller". A small bracket is drawn next to this text. At the bottom center, a large red stamp reads "COPY".*)
...
*Image: A pinkish, aged paper slip with two punch holes at the bottom. The slip contains multiple stamped ink marks indicating receipt by the FBI, U.S. Department of Justice, and specific internal divisions. A handwritten note in black ink is present below the stamped text. There are faint traces of text from the reverse side bleeding through.*
...
*Image: A manila file folder tab or fastener strip, horizontally oriented, showing signs of age with minor creasing and discoloration. A black circular reinforcement ring is visible at the top center.*
...
*Image: A torn, aged, yellowed newspaper clipping from the "Times" newspaper. The paper is dark brown/orange with age, with ragged edges, particularly on the left and top. The top left corner of the newspaper name is torn off.*
...
*Image: A black-and-white artist's sketch of a flying saucer. The main illustration shows a wide, flat, disc-shaped object with a central dome and a thick, cylindrical raised section around the dome. It is emitting fiery plumes from its side. To the left is a vertical arrow labeled "10FT" indicating height. Below the main drawing are three smaller view diagrams labeled "SIDE VIEW" (showing a low profile), "BOTTOM VIEW" (showing a circle with a central point), and "END VIEW" (showing a triangular profile). A horizontal dimension line across the main disc is labeled "20 FT".*
...
---
*Image: Scanned newspaper clipping from the Times-News, Twin Falls, Idaho. The clipping is yellowed and shows signs of age. The main section is titled "Twin Falls News in Brief." It is surrounded by columns of other news items, including "Four Parleys Set on Cassia School Plans," "Funeral Held for Infant at Wendell," "Jenkins May Try Run Tests Friday," and obituaries for William Munger and Harry Piper. There is a small handwritten note in the right margin near the top of the "Four Parleys" article that reads "26".*
...
*Image: Newspaper comic strip panel, part of a vertical column. In the top panel, a man in a cap and work clothes holds a shovel. Another man is partially visible in the background.*
...
*Image: Newspaper comic strip panel. A man in a cap stands in profile, smoking a pipe and holding a coiled rope or leash. A house and another figure are in the background.*
...
*Image: Newspaper comic strip panel. Shows the back of a man's head and shoulders as he looks out a window at a domed building. A calendar hangs on the wall.*
...
*Image: A handwritten page on aged, off-white paper with pencil and ink. At the top is a hand-drawn sketch of a disc-shaped object. Below the sketch is a multi-paragraph handwritten account. The case number "62-83894-115" is written in red ink in the top left corner. Faint pencil annotations are visible in the margins.*

### [Handwritten Sketch of Object]
*Image: A pencil sketch showing a side-view of a wide, flat, disc-shaped object. The object has a raised, domed central section with a visible, red-colored horizontal line or "tublar flame" running along its side. A dashed line from the left points to the edge of the disc, labeled "pits or rounding". The central red feature is labeled "Tublar pip of flame".*
...
### Top View
*Image: A hand-drawn sketch in blue crayon or pencil showing an elongated, pointed oval or disc shape. The top surface is marked with horizontal lines. Handwritten labels at the top center read "top view". A label on the left side reads "front toward". A label on the right side reads "back view".*

### Side View
*Image: A hand-drawn side profile sketch in blue crayon or pencil. The object appears as a flat base with a raised central structure. A red horizontal line is drawn within the central structure. A vertical dimension line on the left is labeled "10 ft. high". A vertical dimension line on the right is labeled "10 ft". A horizontal dimension line below the object is labeled "20 ft long". A handwritten label above the drawing reads "side view".*

### Bottom View
*Image: A hand-drawn sketch in blue crayon or pencil showing the underside of the disc-shaped object, similar in outline to the top view. A vertical line is drawn near the center. A vertical dimension line on the left is labeled "10 ft wide". A horizontal dimension line below the object is labeled "20 ft. long". A handwritten label above the drawing reads "bottom view".*
...
*Image: The rest of the page is blank, showing only two punch holes at the top and some faint, illegible text showing through from the reverse side.*
...
*Image: A tan or manila-colored document folder or file jacket. The surface is largely blank. The bottom portion contains several faded ink stamps, applied upside-down relative to the folder's orientation. There are two dark, irregular holes near the top edge, likely from a fastener. Some small dark marks or ink smudges are visible in the upper right corner.*
...
*Image: Black-and-white photograph of numerous small fragments and several larger, distinct objects arranged on a light-colored, flat surface. The fragments appear to be of metallic or composite material, some with dark, possibly burnt or coated surfaces. In the upper row, from left to right: a dark, circular disc object with a central hub; a dark, cylindrical object with wires extending from it; a dark, rectangular component with wires and what appears to be a connector; a broken, curved, ring-like fragment. Below these, scattered across the surface, are dozens of irregularly shaped shards and pieces of varying sizes, some appearing flat, others with texture or layered composition. A vertical red stamp on the right edge reads "ENCLOSURE".*
...
*Image: A weathered, off-white piece of paper with ragged, torn edges, showing two hole-punch marks at the top. The paper contains the typed text transcribed above. The background is dark, and a small blue rectangular box with white text reading "This image contains all the information on the document." is visible in the lower-left corner, partially obscuring the typed signature block.*
...
*Image: A photograph of a portion of a typewritten letter on "Federal Bureau of Investigation / United States Department of Justice" letterhead. The top right corner features a "FOR VICTORY BUY UNITED STATES WAR BONDS AND STAMPS" poster. A handwritten name "Hotchkiss" appears in blue ink. Multiple stamps and handwritten notations are present, including a "RECORDED EX-93" stamp, a file number "62-83894-128", and a date stamp "5 5 OCT 22 1947". A large, cursive initial "d" is written in red ink on the right margin.*
...
*Image: Aged, light brown or manila document page with visible foxing and age spots. The top of the page shows two hole-punch circles and a torn edge. The main body of the page contains faint, mostly illegible typed text that appears to be the reverse side of a document showing through, or very faded text. Two official ink stamps are visible at the bottom.*
