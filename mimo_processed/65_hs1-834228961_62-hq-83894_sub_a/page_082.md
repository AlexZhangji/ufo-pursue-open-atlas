## Handwritten Annotations (Top of Page)
*[Handwritten in top margin]:* Flying Discs
*[Handwritten in top margin, right]:* Hi Smith

## Newspaper Clipping: Washington Post
...
### Text
"Flying saucers" are in fact radically new type aircraft, conforming to known areodynamic laws and probably developed by the United States Navy, the magazine United States and World Report said yesterday.
...
The weekly news magazine did not quote any authority for its statement that the "flying saucers" are real American planes, but said that "engineers competent to appraise reports of reliable observers reach these conclusions:
...
The Navy declared it was true that its abandoned "flying pancake" was designed by Zimmerman, and was called the "Zimmerman Skimmer." It added that a smaller scale model—one-third of actual size—is still at NACA's Langley, Va., laboratory for wind-tunnel tests, but the Navy insisted it had no such project now active.
...
### Photograph
*Image: A document page with two newspaper clipping articles side by side and a large sepia-toned press photograph of a model aircraft on the right, annotated with handwritten notes, punched holes, and date stamps.* "Model of aircraft developed in 1948 and flown by the Navy under radio control—full-size craft never flew, the Navy has announced"
*Photo credit:* Associated Press Photo

## Archival Stamps and Markings

### Case Number and Date Stamp
> **62-83894-A**
> **NOT RECORDED**
> **83 APR 11 1950**
...
*[Handwritten note]:* Feb 5 - 5th Division
