...
*Image: newspaper clipping with orange-yellowed background, pinned to a white document page with a black pin at the top left corner. The clipping has a headline and body text in three columns.*
...
The interceptors did not sight any more lights after that. Although the radar screen still picked up the objects. One plane landed shortly before midnight, and the other about 12:15 a.m.
...
Radar operators plotted their speed at from 38 to 90 miles per hour. They were not able to determine their altitude. Some pilots reported flying over them and some under them.

Before last week's report of the mysterious lights, so-called "flying saucers" are believed never to have been picked up on radar screens. The objects shown on the National Airport radar, however, caused definite "blips" on the screen, which means contact with solid objects, rather than lights or reflections.

A CAA spokesman said the objects picked up last night gave off blips similar to those of regular aircraft.
...
*[handwritten in margin]:* 319
*[handwritten note]:* 20 AUG 4 1952
*[handwritten note]:* |62-83894-A|
*[handwritten note]:* NOT RECORDED 98 JUL 31 1952
*[handwritten note]:* Date: JUL 27 1952