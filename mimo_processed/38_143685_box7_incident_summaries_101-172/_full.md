# 38_143685_box7_incident_summaries_101-172

Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: 38_143685_box7_incident_summaries_101-172.pdf.
...
*Image: Aged, light-brown manila cover sheet for a file folder. Two punch holes are visible along the left edge.*
...
*Image: Dark, grainy scan of a typewritten document. The text is light-colored against a dark background. "CONFIDENTIAL" stamps are visible at the top and bottom of the page, both struck through with a horizontal line. The top stamp is partially faded. Three hole-punch marks are visible on the left margin. A handwritten number "102" is visible in the bottom right corner.*
...
*Image: A dark, aged document page with two "CONFIDENTIAL" stamps. The top stamp is struck through with a horizontal line. The bottom stamp is also struck through. The page has two hole-punch marks on the left margin. A small handwritten number "186" appears in the upper right corner, and a small handwritten symbol appears in the lower right corner.*
...
*Image: Hand-drawn sketch on dark background (appears to be a photographic negative or blueprint-style reproduction). The sketch depicts a two-part device connected by a cable.*
...
*Image: A dark, high-contrast sketch or diagram on a black background, appearing to be a page from a classified report. The page is heavily creased with a diagonal fold from top-left to bottom-right. Two hole punches are visible on the left margin. The diagram depicts a sequence of observations of unidentified objects in the sky, with handwritten directional indicators and typed narrative text.*
...
*Image: High-contrast black-and-white scan of a dark, possibly black, paper form titled "RESTRICTED". The form is a "CHECK-LIST - UNIDENTIFIED FLYING OBJECTS" with 26 numbered fields filled in with white typewritten text. The paper shows signs of age, with visible holes on the left side, suggesting it was once kept in a binder. The word "RESTRICTED" is stamped in large, distressed letters at the top and bottom.*
...
*Image: A dark, vertical rectangular document page with two hole-punch marks visible on the left margin. The top and bottom of the page are stamped "RESTRICTED" in faint, capital letters. A handwritten number "119" appears in the bottom right corner.*
...
*Image: Scanned document page. The page is dark, almost black, with white typed text centered near the top. The words "RESTRICTED" appear as faint, large watermark-style stamps—one at the top header and one in the center of the page. There are two hole-punch marks on the left margin and two white circular marks (possibly hole-punch reinforcements or scanner artifacts) at the bottom edge. In the bottom right corner, a small handwritten annotation in white reads "1194". In the top left corner, a faint handwritten number "597" is visible.*
...
*Image: A typed checklist form on a dark background (likely a negative or aged document), punched with two holes on the left side for a binder. The top and bottom are stamped "RESTRICTED". At the bottom right corner, there are handwritten initials "SY". The text is in a typewriter font.*
...
*Image: The document page appears heavily blacked out or on dark paper with white text and stamps. The word "RESTRICTED" is stamped in large, faint block letters near the top center and again in the lower half of the page. There are two punch holes on the left margin. A small handwritten number "866" is visible in the bottom right corner.*
...
*Image: A dark, high-contrast photocopy or scan of a typed form on dark background. Two hole-punch circles are visible at the top. A faint "CONFIDENTIAL" stamp appears across the top edge. The number "s/" is handwritten in the bottom right corner.*
...
*Image: Hand-drawn sketch on dark background, depicting a Z-shaped or zigzag-shaped object. The shape consists of two horizontal wings connected by a vertical section. Both wings are covered with numerous small circles. A dimension line above the top wing indicates a width of "6' to 8'". A dimension line to the right indicates a height of "1-1/2' x 2'". A handwritten arrow points to one of the circles on the lower wing with an inverted text note.*
...
*Image: A hand-drawn map or sketch on a dark background, possibly a negative or white-on-dark drawing. The map depicts an intersection of roads, a creek, and wooded areas. A north arrow points upward. The word "CONFIDENTIAL" is stamped at the top right and bottom left.*
...
*Image: Hand-drawn sketch on dark paper, depicting a rounded, dome-like object with a flattened base. The sketch is in white or light-colored ink. A vertical dimension is marked as "6' to 8'". A horizontal dimension across the base is marked as "20'". An arrow points to hatched lines on the right slope of the object, with a handwritten annotation: "NOTED SHADOW." Below the sketch, centered: "(Ration approx. 3:1)". In the lower right corner: "/s/ Russell J. Carey Jr., / RUSSELL J. CAREY JR. / 1st Lt., USAF / Intel Officer". In the lower left margin, handwritten: "93". In the right margin, handwritten: "157". The word "CONFIDENTIAL" is stamped at the top and bottom of the page, both crossed out with a diagonal line.*
