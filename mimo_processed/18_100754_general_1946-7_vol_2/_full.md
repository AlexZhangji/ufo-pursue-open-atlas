# 18_100754_general_1946-7_vol_2

Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: 18_100754_general_1946-7_vol_2.pdf.
...
| TO: | TO: | TO: | TO: | TO: |
| :--- | :--- | :--- | :--- | :--- |
| MRD | Memo to AMC Attn: TSDIN | | | |
| **DATE:**<br>24 Dec 47 | **DATE:**<br>30 Dec 1947 | **DATE:** | **DATE:** | **DATE:** |
...
**BY COMMAND OF THE CHIEF OF STOCK:**

*[handwritten annotation in right margin, vertical]*: 6000

*[handwritten annotation in right margin, vertical]*: thru back

*[handwritten initial near signature]*: *[signed: L.C. Craigie]*
...
*[handwritten number]*: P 97084

*[handwritten stamp]*:
AARD
2 JAN 1948

*[handwritten annotation near Inclosure 1]*: *70*

**4 Incles**

1. Memo dtd 23 Sept '47 from AMC to AC/AS-2 *(Gen Schulgen)*

2. Memo dtd 24 Sept '47 from AMC to AC/MR *(Gen McDonald)*

3. Memo dtd 17 Dec '47 to Gen Craigie

4. R&R from Dir of Intell/w/

### OFFICE SYMBOL

### GRADE AND SURNAME OF COORDINATING OFFICERS

| 1. AFMRS | 2. AFOIN | 3. AFSPR | 4. AFOPO |
| :--- | :--- | :--- | :--- |
| *[handwritten signature]* | McDonald | *[handwritten signature]* | Wegland |
| (AFMRD) | (AFMRD) | AFMRD | by Fiden |

*[bottom of page stamp, partially obscured]*: SECRET

*[text at bottom right margin]*: 16—29350—2 U. S. GOVERNMENT PRINTING OFFICE
...
1.  The marks appearing on the photographs inclosed in basic letter are believed to be defects in the film, paper, or camera and not pictures of "flying discs".
    *[handwritten note above "inclosed": XO6 &]*
...
*[handwritten in right margin, vertically]:* Rec'd & forwarded 12/25/47

*[Stamped: HQ. AAF 22 DEC 1947 AAC MAIL BRANCH]*
...
*[handwritten in left margin]:* n/c

## CONFIDENTIAL

### Coordinating Officers Form

| OFFICE SYMBOL | 1. AFOIR-CO | 2. AFOIR | 3. | 4. | 5. |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **GRADE AND NAME** | Col Taylor | *[handwritten: Eisenman]* | | | |
| **SURNAME OF COORDINATING OFFICERS** | | **C. P. CABELL** | | | |
| | Col Garrett | *[handwritten: Brig. Gen., USAF]* | | | |

*[Top right header, typed]:* AFOIR-CO/Col Garrett/lwd/4544 18 Dec '47

*[Bottom right footer]:* 10-29242-2 U. S. GOVERNMENT PRINTING OFFICE
...
| **SUSPENSE DATE:** | |
| **NO.:** | 242134 |
| **FILE DESIGNATION AND DATE:** | 1177846 |
| **TYPE:** | Ltr |
| **SMRY:** | Flying Disc "Mary L Herren"<br>3 Incls: |
...
`*(Image: A typewritten memorandum on aged, off-white paper. The top and bottom edges are torn and uneven. A red "SECRET" stamp is crossed out with a horizontal line at the top center. A circular stamp in the top left corner is partially visible. A handwritten note in pencil at the top right reads "01R". A date stamp "18 NOV 1947" is on the right side.)*`
...
*[handwritten note]:* C.D. GARRETT, Jr.
*[handwritten note]:* Lt Col USAF
...
`*[Bottom edge of page torn and missing.]*`
...
*Image: A circular stamp in the upper left corner reads "U.S. ARMY SAVE WASTE SALVAGE PAPER".*
...
*Image: A "FOR VICTORY BUY UNITED STATES WAR BONDS AND STAMPS" logo is in the upper right corner.*

**TSNAD-2B/ACL/amb**
**WRIGHT FIELD, DAYTON, OHIO**

### 24 NOV 1947
*[handwritten annotation below date]:* 17: 8
...
*[handwritten annotation in right margin, vertical]:* 6009 Remmer
...
4.  Awaiting a specific directive AMC will continue the investi­gation within its current resources in order to more closely define the nature of the pehnomenon. Detailed Essential Elements of Information will be formulated immediately for transmittal thru channels.
...
Col. Moore - Ch. Aircrft Lab
Mr. DA Sibley - Ch Propeller Lab
Gen D.L. Putt - Eng Div
...
*[handwritten annotation]:* X452.1 Airplanes - Russia

4. A recent report from the U.S. Military attache, Moscow, USSR, dated 9 June 1947, indicates that 1500 aircraft, directly or indirectly based on the Horten VIII design (six engine pusher, having a wing spread of 131 feet and a gross weight of approximately thirty-three thousand pounds) are being built for bomber squadron use. The Russian version, however, is jet propelled, reference report whose identification No. is V-32291-8.

*[handwritten annotation]:* X095

5. The T-2 report "German Flying Wings Designed by Horten Brothers", No. F-SU-1110-Md, also inclosed herewith, may be retained by your office if desired.
...
*[handwritten note]:* Enclosures mailed with original letter
18 Dec 47
*[signed: illegible]*
...
**INDEX:**
452.1 Aircraft - Misc.
0009 Flying Saucer - Phenomena

**TO:** CSGID, Plans and Collection Bra`"n`
...
**INDEXER:** C
**REMARKS:**
*[handwritten note]:* Re: German scientist.
...
1.  A representative of this headquarters has contacted Lt. Colonel Herbert C. Gee concerning Mrs. Merchant's theory on the flying discs, as expressed to General Brentnall.
...
### Routing/Coordination Table

| OFFICE SYMBOL | SIGNATURE OF RESPONSIBLE OFFICER | INTERNAL OFFICE COORDINATION | 2 | 3 | 4 | 5 | 6 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **1 AFOIR-CO** | *Col Dayhuff* | *LCol Garrett* | **AFBIR** | | | | |
| | *Eiseman* | *Geo. F. Schulgen* | *Brig. Gen., USAF* | | | | |

*16-29242-1 U.S. GOVERNMENT PRINTING OFFICE*
...
*Image: The document is a typewritten memorandum on aged, light-grey paper. A red "CONTIDENTIAL" stamp is crossed out with a single black line at the top center. Another red "CONTIDENTIAL" stamp, also crossed out, appears at the bottom center. The top left and bottom right corners have "COPY" written vertically. The bottom left corner has a handwritten notation "Incl #1". The paper shows signs of age, including some discoloration and punch holes on the left margin.*
...
1.  General Brentnall, during a recent visit at Las Vegas, was contacted by a Mrs. Madeline Gwynne Merchant, Sante Fe, New Mexico, who described what may be termed a novel theory concerning "Flying Discs".

2.  According to her thoery, "Flying Discs" are being fired from a locality in Central Mexico from a laboratory which is being operated by the Russians. She claims they are being aimed at the United States for the purpose of sighting in on important atomic energy and aircraft installations.

3.  General Brentnall states that he does not have any further interest in an interrogation of Mrs. Merchant since it is not an engineering matter. However, he recommends that if Hq, Air Materiel Command, T-2, wishes to sponsor an interrogation of this nature that Col. Howard Bunker should be contacted to determine the name and address of the colonel at Las Vegas who has knowledge of this case. In view of General Brentnall's suggestion, no direct contact will be made with Mrs. Merchant.

4.  It is requested, therefore, that the name and address of the above mentioned colonel be made available to this office as soon as possible so that further action, as deemed advisable, can be taken.
...
# TRANSMITTAL SLIP / RECORD

**CLASSIFICATION:** *[REDACTED — Classification marking obscured by damage/stain]*
...
| **SUSPENSE DATE:** | *[BLANK]* |
| **NO.:** | **234015** |
| **FILE DESIGNATION AND DATE:** | **P 94846** |

### SUMMARY (SMRY)
"Flying Discs"
W/ 2 Incls.

*Image: A handwritten notation in cursive ink appears below the typed summary. It appears to read "1st Encl" or similar, though the second word is illegible.*
...
| :--- | :--- |
| **BIR** | **15 Oct 47** |
| *[Handwritten: illegible initials, possibly "CME" or "UME"]* | *[Handwritten note obscures date]* |
| *[BLANK]* | *[BLANK]* |
| *[BLANK]* | *[BLANK]* |
| *[BLANK]* | *[BLANK]* |
...
**OFFICE CODE (Bottom Right):** HQ AAF
...
Basic: Ltr fr Hq, AMG, Wright Fld, Dayton, O. 24 Sept 47, Subj: "Flying Saucers"
...
Department of the Air Force, Hq, USAF, Washington 25, D. O.
**8 OCT 1947**
...
### OFFICE SYMBOL
1. Memo for AO/MR, 28 Sept 47 w/Map
2. Memo for Chief, Air Intel Div, 2 Oct 47
3. Summary of Info on "Unidentified Flying Objects" Lt Col Garrett
...
*[handwritten in margin]*: re: 9 flying saucers
...
*[handwritten in margin]:* File recommendation

### HQ AAF
**11 SEP 1947**

*[handwritten annotation below stamp]:* ACO

Incl a/s in par. 1.

*[handwritten annotation in lower left]:* m
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| | AFBIR-CO | AFBIA | | | |
| **GRADE AND SURNAME OF COORDINATING OFFICERS** | Col. Taylor 3rd | Eisman | | | |
| | | Geo. F. Schulgen<br>Brig. Gen., USA | | | |
| | Lt Col Garrett | | | | |

*[handwritten annotation next to Col. Taylor 3rd]:* *[illegible]*

*[handwritten signature at bottom left]:* *[signed: illegible]*
...
*[Handwritten note in margin]:* *[illegible initials]*
...
| Office/Position | Signature/Name |
| :--- | :--- |
| AFDRE | *[handwritten signature: illegible]* |
| AFDRE-2 | *[handwritten signature: illegible]* |
| AFDRE-3 | *[handwritten signature: illegible]* |
| AFDRE-4 | *[handwritten signature: illegible]* |

*[handwritten signature above printed name]:* *[signed: Curtis E. LeMay]*
**CURTIS E. LeMAY**
Major General, U. S. Army
Deputy Chief of Air Staff for Research and Development
