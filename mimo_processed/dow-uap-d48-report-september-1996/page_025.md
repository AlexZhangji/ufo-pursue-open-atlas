...
To predict failure probabilities for Atlas, Delta, and Titan, the test results in Appendix D for representative configurations (i.e., "1" in last column) have been filtered using three different weighting techniques described in Appendix C:
