...
(2) Effects on shaping constants A and B (and thus overall risks) if different values of T<sub>B</sub> are used in computing theoretical and simulated impacts (e.g., T<sub>B</sub> corresponding to burnout of zero, first, and second stages).
