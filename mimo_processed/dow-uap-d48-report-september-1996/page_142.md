...
| :--- | :--- |
| Delta | Stg. 1: Modified Thor. MB-3 Blk I engine<br>Stg. 2: Vanguard AJ10-118 propulsion system<br>Stg. 3: Vanguard X-248 motor |
| A | Stg. 1: Engine replaced with MB-3 Blk II |
| B | Stg. 2: Tanks lengthened; higher energy oxidizer used |
| C | Stg. 3: Replaced with Scout X-258 motor<br>PLF: Bulbous replaced low drag |
| D | Stg. 0: Added 3 Thor-developed SRMs (Castor I) |
| E | Stg. 0: Castor II replaced Castor I<br>Stg. 1: MB-3 Blk III replaced Blk II<br>Stg. 2: Propellant tank diameters increased<br>Stg. 3: Replaced with USAF-developed FW-4 motor<br>PLF: Fairing enlarged to 65-inch diameter |
...
| 900 | Stg. 0: No Castor IIs employed<br>Stg. 2: Replaced with Transtage AJ10-118F engine |
| 1604 | Stg. 0: Six Castor IIs employed<br>Stg. 3: Replaced with TE-364-4 |
