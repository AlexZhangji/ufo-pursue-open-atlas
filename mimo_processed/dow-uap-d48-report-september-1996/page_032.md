*Image: A line graph titled “Figure 4. Filter Factor Results for Representative Configurations of Atlas,” plotting Filtered Failure Probability versus Sample Index (newer →), with three overlaid lines labeled F = 0.97, F = 0.98, and F = 0.99.*
