...
| Vehicle | Flight Phase | T<sub>B</sub> (sec) | Breakup qα (deg-lb/ft²) | | |
| :--- | :---: | :---: | :---: | :---: | :---: |
| | | | **5,000** | **10,000** | **20,000** |
...
| Vehicle | Flight Phase | T<sub>B</sub> (sec) | Breakup qα (deg-lb/ft²) | B | A |
| :--- | :---: | :---: | :---: | :---: | :---: |
