...
Generated by MiMo-V2.5 VLM extraction. Prompt: v3.1-uap-archive. Source PDF: 65_hs1-101634279_100-de-26505.pdf.
...
*Image: Vertical barcode on the left side of the label. Text to the left of barcode: "RRP000PJD9". Text to the right of barcode: "8/08/374524".*

## Cover Page Header
U. S. Department of Justice
MUST NOT BE REMOVED FROM OR ADDED TO THIS FILE)

*Image: Partial text visible on the right side of the page, seemingly part of a large departmental header or stamp:*
BUREAU
of
TIGATION
...
*Image: Hand-drawn sketch on lined paper, resembling a target or scope view with concentric circles. Three small circles are positioned along a horizontal line within the innermost ring.*

*Image: Sketch of a flying saucer-like object, disc-shaped with a central dome, viewed from the side.*

*Image: Sketch of a spherical or planet-like object with horizontal bands and a ring system.*

*Image: Sketch of a dark, irregularly shaped object.*

*Image: Hand-drawn diagram or map featuring a large circle with internal markings, including lines radiating from a central point, a shaded area, and a cross. The numbers "44–45" are written to the right.*

*Image: Sketch of a shield or crest shape with an internal cross or 'X' pattern.*
...
*high*
*go*
*Image: Sketch of a swirling, spiral, or vortex-like shape.*

*"Sulclitt"*
*Gobssen*
*55 Major*

*Image: Sketch of a small, dark, oval or football-shaped object with a zigzag pattern inside.*

*Image: Sketch of a small, irregular shape.*

*Image: Sketch of a small diamond or rhombus shape with the number "55" inside.*
